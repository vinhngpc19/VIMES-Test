      ...
      child: Column(
        ...
        children: [
          CustomInputText(
            ...
            focusNode: notifier.unitFocusNode,
          ),
          CustomInputText(
            hintText: 'Bộ phận',
            title: 'Bộ phận',
            ...
            focusNode: notifier.departmentFocusNode,
          ),
          DatePicker(
            title: 'Ngày nhập kho',
            ...
            children: [
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  focusNode: notifier.stockInNumberFocusNode,
                ),
              ),
              ...
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  focusNode: notifier.debitNumberFocusNode,
                ),
              ),
              const SizedBox(width: 40),
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  focusNode: notifier.creditNumberFocusNode,
                ),
              ),
            ],
          ),
          ...
          CustomInputText(
            ...
            focusNode: notifier.deliverNameFocusNode,
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  focusNode: notifier.byNameFocusNode,
                ),
              ),
              const SizedBox(width: 40),
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  focusNode: notifier.byNumberFocusNode,
                ),
              ),
            ],
          ),
          ...
          CustomInputText(
            ...
            focusNode: notifier.byOwnerFocusNode,
          ),
          CustomInputText(
            ...
            focusNode: notifier.stockInAtFocusNode,
          ),
          CustomInputText(
            hintText: 'Địa điểm',
            title: 'Địa điểm',
            ...
            focusNode: notifier.stockInAdressFocusNode,
          ),
          Padding(
            padding: const EdgeInsets.only(top: 16.0),
            child: Divider(
