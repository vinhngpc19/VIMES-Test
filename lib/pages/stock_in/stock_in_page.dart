...
class _StockInPageState extends State<StockInPage> {
  ...
  Widget _buildForm() {
    return Form(
      ...
      autovalidateMode:
          notifier.isFirstValidate ? AutovalidateMode.always : null,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          CustomInputText(
            ...
            currentNode: notifier.unitFocusNode,
          ),
          CustomInputText(
            hintText: 'Bộ phận',
            title: 'Bộ phận',
            ...
            currentNode: notifier.departmentFocusNode,
          ),
          DatePicker(
            title: 'Ngày nhập kho',
            ...
            children: [
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  currentNode: notifier.stockInNumberFocusNode,
                ),
              ),
              ...
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  currentNode: notifier.debitNumberFocusNode,
                ),
              ),
              const SizedBox(width: 40),
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  currentNode: notifier.creditNumberFocusNode,
                ),
              ),
            ],
          ),
          ...
          CustomInputText(
            ...
            currentNode: notifier.deliverNameFocusNode,
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  currentNode: notifier.byNameFocusNode,
                ),
              ),
              const SizedBox(width: 40),
              SizedBox(
                ...
                child: CustomInputText(
                  ...
                  currentNode: notifier.byNumberFocusNode,
                ),
              ),
            ],
          ),
          ...
          CustomInputText(
            ...
            currentNode: notifier.byOwnerFocusNode,
          ),
          CustomInputText(
            ...
            currentNode: notifier.stockInAtFocusNode,
          ),
          CustomInputText(
            hintText: 'Địa điểm',
            title: 'Địa điểm',
            ...
            currentNode: notifier.stockInAdressFocusNode,
          ),
          Padding(
            padding: const EdgeInsets.only(top: 16.0),
            child: Divider(
            ...
            children: [
              ...List.generate(
                ...
                (index) => StockInInputItem(
                    index: index,
                    mapController: notifier.itemControllers[index]),
              ),
              Padding(
  ...
  Widget _buildSignaturePad() {
    return Column(
      ...
      children: [
        Container(
          ...
          child: SfSignaturePad(
            ...
            onDrawEnd: () async {
              ...
              final image =
                  await notifier.signaturePadKey.currentState?.toImage();
              if (image != null) {
        ...
        if (!notifier.hasSignature && notifier.isFirstValidate)
          const Padding(
        ...
        Align(
          ...
          child: GestureDetector(
            onTap: () {
              notifier.signaturePadKey.currentState?.clear();
